...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/styles/bootstrap4/google_fonts.css');?>">
...
<form name="billing" method="post" action="<?php echo site_url('shopping_cart/save_order') ;  ?>" >
<input type="hidden" name="command" />
<div align="center">
<h1 align="center">Billing Info</h1>
<table border="0" cellpadding="2px">
<tr><td>Order Total:</td><td><strong><?php echo number_format($grand_total, 0); ?> Shs</strong></td></tr>
...
echo "<a class ='fg-button teal'  id='back' href=" . site_url('jep_controller') . ">Back</a>"; ?>
