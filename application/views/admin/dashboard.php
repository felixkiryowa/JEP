...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('best_sellers_controller/');?>" style="color: #EA5B77;">Manage Best Sellers   <span class="glyphicon glyphicon-arrow-right"></span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('orders_controller/');?>" style="color: #EA5B77;">Manage Orders   <span class="glyphicon glyphicon-arrow-right"></span></a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:#EA5B77;">Add a new pair of earings</h4>
            ...
            <div class="row" style="padding-left:970px;">
               <button class="btn btn-default" data-toggle="modal" data-target="#earingModal" id="addEaringModalBtn">
                    <span class="glyphicon glyphicon-plus-sign"></span> Add Pair
               </button>
            ...
            <div class="row">
                <div class="col-lg-12">
                   <table class="table table-bordered table-stripped table-condensed " width="100%" id="EarRings" >
                    <thead>
                        <tr>
                            <th style="color:#EA5B77;">Id</th>
                            <th style="color:#EA5B77;">Title</th>
                            <th style="color:#EA5B77;">Featured</th>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" align="center" style="color:#EA5B77;" id="myModalLabel">Add New Pair Of Earings</h4>
		  </div>
		  <div class="modal-body">
                     ...
                     <?php echo  form_open_multipart('save_earings/add_pair_of_earings'); ?>
				  ...
				  <div class="form-group">
                                         ...
                                         <?php
                                                      $options = array(
                                                          '0'  => 'Not On featured section',
                                                          '1'    => 'On featured section',
                                        ...
                                        echo form_dropdown('featured', $options, '0','class="form-control"');
