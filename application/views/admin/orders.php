...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:#EA5B77;">All Orders Received</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                   <table class="table table-bordered table-stripped table-condensed " width="100%" id="Orders" >
                    <thead>
                        <tr>
                            <th style="color:#EA5B77;">Number</th>
                            <th style="color:#EA5B77;">Customer Name</th>
                            <th style="color:#EA5B77;">Email</th>
                            <th style="color:#EA5B77;">Address</th>
                            <th style="color:#EA5B77;">Contact</th>
                            <th style="color:#EA5B77;">Ordered Products</th>
