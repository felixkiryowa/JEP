...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('dashboard_controller/');?>" style="color:#EA5B77;"> <span class="glyphicon glyphicon-arrow-left"></span>  Manage Earings</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:#EA5B77;">Add a New Bag</h4>
            ...
            <div class="row" style="padding-left:970px;">
               <button class="btn btn-default" data-toggle="modal" data-target="#earingModal" id="addEaringModalBtn">
                    <span class="glyphicon glyphicon-plus-sign"></span> Add Bag
               </button>
            ...
            <div class="row">
                <div class="col-lg-12">
                   <table class="table table-bordered table-stripped table-condensed " width="100%" id="Bags" >
                    <thead>
                        <tr>
	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" align="center" style="color:#EA5B77;" id="myModalLabel">Add New Bag</h4>
		  </div>
		  <div class="modal-body">
                     ...
                     <?php echo  form_open_multipart('save_bags/add_a_bag'); ?>
