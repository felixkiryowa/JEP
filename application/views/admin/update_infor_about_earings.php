...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header" style="color:#EA5B77;">Edit  pair of Added earings</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php echo form_open('save_earings/save_editted_info/'.$pair->id);?>
                        ...
                        <div class="modal-body">
                                ...
                                $data = array( 'name'=> 'edit_title',
                                               ...
                                               'value'=> set_value('edit_title',$pair->title),
                                               'class' => 'form-control'
                                               );
                                ...
                                $price = array( 'name'=> 'edit_price',
                                               ...
                                               'value'=> set_value('edit_price',$pair->price),
                                               'class' => 'form-control'
                                               );
                                       ...
                                       <?php echo form_label('Description :', 'edit_description');?>
                                        <?php
                                          $description = array(
                                                        ...
                                                        'value'=> set_value('edit_price',$pair->description),
                                                        'rows'        => '3',
                                                        'class'       => 'form-control'
