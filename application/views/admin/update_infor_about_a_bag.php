...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php echo form_open('save_bags/save_editted_bag_info/'.$bag->id);?>
                        ...
                        <div class="modal-body">
                                ...
                                $data = array( 'name'=> 'edit_title',
                                               ...
                                               'value'=> set_value('edit_title',$bag->title),
                                               'class' => 'form-control'
                                               );
                                ...
                                $price = array( 'name'=> 'edit_price',
                                               ...
                                               'value'=> set_value('edit_price',$bag->price),
                                               'class' => 'form-control'
                                               );
                                       ...
                                       <?php echo form_label('Description :', 'edit_description');?>
                                        <?php
                                          $description = array(
                                                        ...
                                                        'value'=> set_value('edit_price',$bag->description),
                                                        'rows'        => '3',
                                                        'class'       => 'form-control'
